...
fun LoginScreen(
    ...
    if (showRegisterDialog) {
        AlertDialog(
            ...
            confirmButton = {
                Button(
                    onClick = {
                        viewModel.registerUser(registerUsername, registerPassword) { success ->
                            if (success) {
    ...
    if (registerError) {
        AlertDialog(
            onDismissRequest = { registerError = false },
            title = { Text("Registration Failed") },
            text = { Text("Username already exists") },
            confirmButton = {
                Button(
                    onClick = { registerError = false }
                ) {
                    Text("OK")
                }
            }
    ...
    Box(
        ...
        Column(
            ...
            Button(
                onClick = {
                    viewModel.validateCredentials { isValid ->
                        if (isValid) {
    ...
    fun MenuMainScreen(navController: NavHostController, menuManager: MilkTeaMenuManager) {
        Scaffold(
            ...
            Column(
                ...
                MenuOptionButton("Browse by Category", Icons.Default.Search) {
                ...
                MenuOptionButton("View Full Menu", Icons.Default.Search) {
                    navController.navigate("menu_full")
                }
